    ...
    $.widget("ui.timeslider", {
    	timeConverter: function(UNIX_timestamp){
			...
			if (hour > 12) {
		   	...
		   	var time = date+', '+month+' '+hour+':'+min+':'+sec + ' ' +ampm ;
        ...
        _slideTime: function (event, ui){
            ...
            if(that.slider( "option", "range" )){
                startTime = that.timeslider('timeConverter',that.slider("values", 0), that.timeslider('option', 'clockFormat'));
                $('#time-slider-value1').html( that.slider("values", 0));
                $('#time-slider-value2').html( that.slider("values", 1));

                endTime = that.timeslider('timeConverter', that.slider("values", 1), that.timeslider('option', 'clockFormat'));
                ...
                startTime = that.timeslider('timeConverter', that.slider("value"), that.timeslider('option', 'clockFormat'));
