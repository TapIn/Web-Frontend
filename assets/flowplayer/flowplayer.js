/*!
   ...
   Flowplayer Commercial v5.0.0 (Thursday, 27. September 2012 02:43PM) | flowplayer.org/license
...
$.extend(flowplayer, {
   ...
   conf: {
      ...
      swf: "http://releases.flowplayer.org/5.0.0/commercial/flowplayer.swf",
   ...
   var engine = {
      ...
      load: function(video) {
         ...
         if (conf.rtmp) {
            ...
            if (source.type == "mp4" || source.type == '') url = "mp4:" + url;
            source.url = url;
         }
...
flowplayer(function(api, root) {
   ...
   var conf = api.conf,
      origin = conf.swf.indexOf("flowplayer.org") && conf.e && root.data("origin"),
      domain = origin ? getHost(origin) : location.hostname,
      key = conf.key;

   if (location.protocol == 'file:') domain = "localhost";

   // Cross dependency with flowplayer.js. Change the logic between versions
   api.load.ed = 1;
   ...
   // valid --> draw .fp-logo element
   if (key && typeof key_check == 'function' && key_check("" + key, domain)) {

      if (conf.logo) {
         root.append(
            $("<a>", { 'class': 'fp-logo', href: origin })
               .append($("<img/>", { src: conf.logo }))
         );
      }
   ...
   // not valid
      ...
      var logo = $("<a/>").attr("href", "http://flowplayer.org").appendTo(root),
         controls = $(".fp-controls", root);

      root.bind("mouseenter mouseleave", function(e) {
         if (api.ready) logo.toggle(e.type == 'mouseenter');
      });

      api.bind("progress unload", function(e) {

         if (e.type == "progress" && api.video.time < 8 && api.engine != "flash" && root.hasClass("is-mouseover")) {

            logo.show().css({
               position: 'absolute',
               left: 6,
               bottom: controls.height() + 12,
               zIndex: 99999,
               width: 100,
               height: 20,
               cursor: 'pointer',
...
/*
   Commercial key for flowplayer.js
*/

function key_check(key, host) {

   var TLD = ("br.com,cn.com,eu.com,hu.com,no.com,qc.com,sa.com,se.com,us.com,uy.com,uk.com,gb.com,com," +  // com
   "co.ac,gv.ac,or.ac,ac.ac,ac,ac.at,co.at,gv.at,or.at,asn.au,com.au,edu.au,org.au,net.au,id.au," + // ac, at, au
   "adm.br,adv.br,am.br,arq.br,art.br,bio.br,cng.br,cnt.br,com.br,ecn.br,eng.br,esp.br,etc.br,eti.br,fm.br,fot.br,fst.br,g12.br,gov.br,ind.br,inf.br,jor.br,lel.br,med.br,mil.br,net.br,nom.br,ntr.br,odo.br,org.br,ppg.br,pro.br,psc.br,psi.br,rec.br,slg.br,tmp.br,tur.br,tv.br,vet.br,zlg.br,br," +
   "ab.ca,bc.ca,mb.ca,nb.ca,nf.ca,ns.ca,nt.ca,on.ca,pe.ca,qc.ca,sk.ca,yk.ca,ca," + // ca
   "ac.cn,com.cn,edu.cn,gov.cn,org.cn,bj.cn,sh.cn,tj.cn,cq.cn,he.cn,nm.cn,ln.cn,jl.cn,hl.cn,js.cn,zj.cn,ah.cn,gd.cn,gx.cn,hi.cn,sc.cn,gz.cn,yn.cn,xz.cn,sn.cn,gs.cn,qh.cn,nx.cn,xj.cn,tw.cn,hk.cn,mo.cn," +
   "tm.fr,com.fr,asso.fr,presse.fr,fr," + // fr
   "co.il,net.il,ac.il,k12.il,gov.il,muni.il,ac.in,co.in,org.in,ernet.in,gov.in,net.in,res.in," + // il, in
   "ac.jp,co.jp,go.jp,or.jp,ne.jp,ac.kr,co.kr,go.kr,ne.kr,nm.kr,or.kr," + // jp, kr
   "asso.mc,tm.mc,com.mm,org.mm,net.mm,edu.mm,gov.mm," + // mc, mm
   "org.ro,store.ro,tm.ro,firm.ro,www.ro,arts.ro,rec.ro,info.ro,nom.ro,nt.ro," + // ro
   "com.sg,org.sg,net.sg,gov.sg,ac.th,co.th,go.th,mi.th,net.th,or.th," + // sg, th
   "com.tr,edu.tr,gov.tr,k12.tr,net.tr,org.tr,tv.tr," + // tr
   "com.tw,org.tw,net.tw,com.hk,org.hk,net.hk,edu.hk,us,tk,cd,by,ad,lv,eu.lv,bz,es,jp," +
   "net,org,biz,ws,in,me,co,edu,mil," +
   "co.uk,org.uk,ltd.uk,plc.uk,me.uk,ac.uk,uk," +
   "se.net,uk.net,gb.net,af,am,as,at,be,ac.be,cc,cn,cx,cz,de,dk,fo,com.ec,gf,gs,is,it," +
   "li,lt,lu,ms,nl,no,nu,pl,ro,se,si,sk,st,tf,tm,to," +
   "vg,sh,kz,ch,info,ua,gov,name,pro,ie,hk,fi,pe," +
   "cl,ag,mobi,eu,co.nz,org.nz,net.nz,maori.nz,iwi.nz,io,la,md,sc,sg,vc,tw,travel,my,se,tv,pt,com.pt," +
   "edu.pt,asia,com.ve,net.ve,org.ve,web.ve,info.ve,co.ve,tel,im,gr,ru,net.ru,org.ru,hr,com.hr,aero," +
   "cat,coop,int,jobs,museum,xxx,com.qa,edu.qa,gov.qa,gov.au,com.my,edu.my,gov.my").split(",");

   // not an IP
   if (host != 'localhost' && !parseInt(host.split(".").slice(-1))) {

      // go trough TLDs
      for (var i = 0, tld, sld, re; i < TLD.length; i++) {
         tld = TLD[i];
         re = new RegExp("\\.(" + tld.replace(".", "\\.") + ")$");

         if (re.test(host)) {
            sld = host.substring(0, host.indexOf("." + tld)).split(".").slice(-1)[0];
            host = sld + "." + tld;
            break;
         }
      }
   ...
   var expected = key.substring(1, 8),
      sum = 0;

   for (var i = host.length - 1; i >= 0; i--) {
      sum += host.charCodeAt(i) * 2983723987;
   }

   sum = ("" + sum).substring(0, 7);

   // console.info(host, sum, expected);
